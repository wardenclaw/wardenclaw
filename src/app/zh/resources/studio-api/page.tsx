...
export const metadata: Metadata = {
  title: 'Warden Studio API 文档导航',
  description: 'Warden Studio 的 API 接口导航和使用说明，包含认证、Agent 管理和操作监控接口。',
};

export default function Page() {
  return (
    <article className="container-page py-12">
      <Breadcrumb items={[{ label: '首页', href: "/zh" }, { label: '资源', href: "/zh/resources" }, { label: 'Warden Studio API 文档导航' }]} />
      <header className="mb-10">
        ...
        <h1 className="font-display text-3xl sm:text-4xl font-bold text-ink-950 dark:text-ink-50 text-balance">
          Warden Studio API 文档导航
        </h1>
        <p className="mt-4 text-lg text-ink-500 dark:text-ink-400">Warden Studio 的 API 接口导航和使用说明，包含认证、Agent 管理和操作监控接口。</p>
      </header>
      <div className="prose-custom">
        <h2 id="overview">概述</h2>
        <p>Warden Studio 的 API 接口导航和使用说明，包含认证、Agent 管理和操作监控接口。</p>
