...
export const metadata: Metadata = {
  title: '社区代理库和示例项目',
  description: '社区开发者贡献的 Agent 示例和开源项目汇总，帮助你学习和参考他人的实现方案。',
};

export default function Page() {
  return (
    <article className="container-page py-12">
      <Breadcrumb items={[{ label: '首页', href: "/zh" }, { label: '资源', href: "/zh/resources" }, { label: '社区代理库和示例项目' }]} />
      <header className="mb-10">
        ...
        <p className="mt-4 text-lg text-ink-500 dark:text-ink-400">社区开发者贡献的 Agent 示例和开源项目汇总，帮助你学习和参考他人的实现方案。</p>
      </header>
      <div className="prose-custom">
        <h2 id="overview">概述</h2>
        <p>社区开发者贡献的 Agent 示例和开源项目汇总，帮助你学习和参考他人的实现方案。</p>
