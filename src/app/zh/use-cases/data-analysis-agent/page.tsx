...
export const metadata: Metadata = {
  title: '数据分析 Agent 用例',
  description: '用 AI Agent 自动采集和分析链上数据，生成报告和预警的应用场景说明。',
};

export default function Page() {
  return (
    <article className="container-page py-12">
      <Breadcrumb items={[{ label: '首页', href: "/zh" }, { label: '用例', href: "/zh/use-cases" }, { label: '数据分析 Agent 用例' }]} />
      <header className="mb-10">
        ...
        <p className="mt-4 text-lg text-ink-500 dark:text-ink-400">用 AI Agent 自动采集和分析链上数据，生成报告和预警的应用场景说明。</p>
      </header>
      <div className="prose-custom">
        <h2 id="scenario">应用场景</h2>
        <p>用 AI Agent 自动采集和分析链上数据，生成报告和预警的应用场景说明。</p>
