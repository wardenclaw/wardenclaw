...
export const metadata: Metadata = {
  title: 'DeFi Agent 用例：自动交易',
  description: '如何用 Warden + OpenClaw 构建 DeFi 自动交易 Agent，包含策略设计、权限配置和风险控制最佳实践。',
};

export default function Page() {
  return (
    <article className="container-page py-12">
      <Breadcrumb items={[{ label: '首页', href: "/zh" }, { label: '用例', href: "/zh/use-cases" }, { label: 'DeFi Agent 用例：自动交易' }]} />
      <header className="mb-10">
        ...
        <p className="mt-4 text-lg text-ink-500 dark:text-ink-400">如何用 Warden + OpenClaw 构建 DeFi 自动交易 Agent，包含策略设计、权限配置和风险控制最佳实践。</p>
      </header>
      <div className="prose-custom">
        <h2 id="scenario">应用场景</h2>
        <p>如何用 Warden + OpenClaw 构建 DeFi 自动交易 Agent，包含策略设计、权限配置和风险控制最佳实践。</p>
